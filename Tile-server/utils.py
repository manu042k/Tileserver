...
def validate_tiff_file():
    ...
    if not tiff_path.exists():
        print(f"Error: TIFF file not found at path: {TIFF_FILE}")
        print(f"Current working directory: {os.getcwd()}")
        print("Please ensure the file exists or set the correct path using the TIFF_FILE_PATH environment variable")
